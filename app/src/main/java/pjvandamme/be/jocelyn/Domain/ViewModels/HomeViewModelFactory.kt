 ...
 */
class HomeViewModelFactory(private val application: Application, private val recentJottingCount: Int) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return HomeViewModel(application, recentJottingCount) as T
    }
}